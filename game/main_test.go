...
var game0cases = [][]gameCase{
	...
	[]gameCase{
		...
		{16, "осмотреться", "ты в своей комнате, пустая комната, можно пройти - коридор"}, // состояние изменилось
		{17, "идти коридор", "ничего интересного, можно пройти - кухня, комната, улица"},
		{18, "идти кухня", "ты находишься на кухне, ничего интересного, можно пройти - коридор"},
